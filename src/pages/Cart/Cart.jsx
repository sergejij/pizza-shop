...
const PizzaRow = ({
  photo, headline, price, countCart, isTraditional, size,
}) => (
              ...
              <div className={styles.row}>
                <p>
                  ...
                  <span className={styles.allCount}>
                    {pizzas.reduce((acc, pizza) => acc + pizza.countCart, 0)}
                    {' '}
                    шт.
                  </span>
                </p>
                <p>
                  ...
                  <span className={styles.allPrice}>
                    {pizzas.reduce((acc, pizza) => acc + pizza.price * pizza.countCart, 0)}
                    {' '}
                    ₽
                  </span>
                </p>
